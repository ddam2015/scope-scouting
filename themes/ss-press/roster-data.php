...
<?php 
  $boys_divisions = ["Kindergarten"=>[
    ...
    "Rockets"=>["Sean Sheller", "Wed 4pm Court 5", ["Jackson Eberhardt", "Hudson Waken", "Owen Ruziecki", "Jack  Bousky", "Cal Hudson", "Wyatt Sheller", "Braden Burnett", "Nicky Segal", "Gavin White"]],
...
"1st Grade"=>[
  ...
  "Lakers"=>["Kurt Cymerint", "Thurs 4pm Court 5", ["Jace Davies", "Bowie Davis", "Kian Patel", "Lucca Santwire", "Logan Kabine", "Wyatt Patterson", "Noah Cymerint", "Mac Fitzgerald", "Sam Tanner", "John Sanchez"]],
  "Hornets"=>["Navin Jain", "Mon 5pm Court 8", ["Greyson Cole", "Carson Fowler", "Benjamin Somers", "Arman Wakefield", "Cody Gray", "Gibson Pirayoff", "Jake Weingarten", "Mateo Camacho", "Crew Kennedy", "Prish Jain"]],
  ...
  "Jazz"=>["Michael Vancho", "Wed 4pm Court 8", ["Cole Evans", "Raustin Atefi", "LeRoy Nichols V", "Syon Sheth", "James Meshot", "Brayden Vancho", "Mason Silverman", "Aayansh Dave", "Jett Schlegel"]],
  "Celtics"=>["Glenn Wilkerson", "Mon 5pm Court 8", ["Gavin Wurster", "Brooks Howell", "Blake Bickoff", "Bodhi Firoved", "Harrison Porter", "Luke Shafer", "Hudson Brown", "Kai Wilkerson", "Andrew Nesheiwat", "Max Wilson"]]
], 
"2nd Grade"=>[
  ...
  "Clippers"=>["Mike Zhe", "Wed 5pm Court 7", ["Mikey Nelson", "Grady Waters", "Mason Zhe", "Crosby Gallicchio", "Millan Mehta", "Hudson Powell", "Nolan Reinmiller", "Tripp Juarez", "Nolan Stone", "Jaxson Yeager"]],
  "Hornets"=>["Joe Fleskoski", "Tue 4pm Court 7", ["Case Vaughn", "Jackson Fleskoski", "Caden Peterson", "Rowan Brennan", "Hunter Larson", "Oliver Dimick", "Jesse Bahu", "Zaid Adas", "Tyson Bredsguard"]],
  "Celtics"=>["James Atterbury", "Wed 5pm Court 8", ["Hudson Howell", "Reed Steffenhagen", "Colin Brooks", "Noah Gyllenhammer", "Waylon Atterbury", "Parker McKay", "Wolf  Green", "Alexander Rados", "Aiden  Eberhardt", "Easton Ahrens"]],
  ...
  "Lakers"=>["Brian Morales", "Wed 5pm Court 7", ["Jack Kittredge", "Reed Morales", "Declan LeFever", "Zeke Larraga", "Ryan Taylor", "Caleb Donelson", "Roman LaSala", "Cameron Draude", "Sebastian Johnson"]],
  ...
  "Jazz"=>["Jonathan Stevens", "Wed 4pm Court 7", ["Matix Rodriguez", "Brody Evans", "Stockton Stevens", "Collins MacLeod", "Colin Currie", "Dean Davis", "Colin Komppa", "Rojer  Naid", "Theo Halladay"]],
  "Timberwolves"=>["Ben Chamberlin", "Mon 4pm Court 7", ["Joshua Cook", "Dominic Fowler", "Brooks Pollack", "James Baca", "Leo Chamberlain", "Owen Baker", "Rayan Nabavi", "Carson Alexander", "John  Powers", "Tyler Hick"]],
  ...
  "Knicks"=>["Craig Mackey", "Thu 4pm Court 8", ["Aaron Lavi", "Carter Stanfield", "Nate Sandor", "Joey Kanik", "Jaxson Williams", "Evan McManimen", "Easton Ha", "Maddox Melanio", "Greyson Ha", "Gavin Mackey"]]
], 
"3rd Grade"=>[
  "Rockets"=>["Nate Burnett", "Wed 5pm court 8", ["Blake Burnett", "James Mock", "Payden Peetz", "Alex Zhou", "Josh Koenig", "Renzo Broas", "Bennet Koyfman", "Jordy Segal", "Jack Puffer", "Ryan Barsoum"]],
  "Hornets"=>["Bill Turner", "Wed 5pm court 8", ["Enzo DiCaprio", "Beckett Turner", "Luca DeCaprio", "Luca Malanga", "Declan Branning", "Jet Fitzgerald", "Marvin Wang", "Ben Magnusson", "Liam Pappas", "Dylan Navarro"]],
...
"4th Grade"=>[
  ...
  "Jazz"=>["Ben Chamberlin", "Mon 6pm Court 8", ["Xavier LaSala", "Jacob Donelson", "Hollis Waters", "Mason Chamberlin", "Eddie LaFever", "Hudson Bingham", "Cash Hada", "Jackson Chamberlin", "Hyrum Thomas", "Finnley Williams"]],
  "Bucks"=>["Mike Hodson", "Wed 6pm Court 7", ["Joseph Fleskoski", "Oliver Nguyen", "Atticus Hodson", "Jackson Muckley", "Evan Mathews", "Evan Champagne", "Caden Cole", "Beckham Smith", "Anderson Halladay"]],
  ...
  "Timberwolves"=>["Craig Mackey", "Mon 6pm Court 5", ["Garren Mackey", "Blake Dragonetti", "Charlie Hudson", "Benjamin Dulik", "Carson Gardner", "Leo Gaya", "Filippo Bon", "Cruz Bartik", "Jett Foust", "Kian Husmann"]],
  "Celtics"=>["Steve Wight", "Mon 6pm Court 5", ["Maverick Wight", "Cash Skibba", "Matthew Sheen", "Mason Micek", "Jason Cook", "Canaan Steindler", "Elijah Mills", "Brylee Scott", "Deegan Fenn"]],
  ...
  "Lakers"=>["Mike Junge", "Thurs 5pm Court 5", ["Marcel Polan", "Pierce  Bruggeman", "Colby Gartland", "Sean Ruppenthal", "Luke Horvatic", "Santiago Potes", "Grayson Governski", "Matty Junge", "Hammad Siddiqui", "Ollie Eisert"]]
], 
"5th/6th Grade"=>[
  ...
  "Hornets"=>["Noah Larson", "Thur 5pm Court 8", ["Tyler Cierpial", "Riley Jackson", "AJ  Maroutsos", "Colton  Carlton", "Cristiano Bartik", "Dylan Ares", "Brady Larson", "Tyler Garcia Parsons", "Robby Ernst", "Mason Russo"]],
  "Clippers"=>["Christian Rovsek", "Wed 6pm Court 5", ["Noah Williams", "Trenton Davis", "Kingston Rovsek", "Tyler Choan", "AJ Taylor", "Preston Rovsek", "Dylan Lim", "Lincoln Warhurst", "Ezra Jolley", "Hayden Pollack", "Scout Petar"]],
...
"7th/8th Grade"=>[
  "Hornets"=>["Ryan Weller", "Tues 7:30pm Court 7", ["Cooper Chila", "Ryder Hoffman", "Gunnor Bachhuber", "Jack Weller", "Rush Davis", "Johnny Dordell", "Conor Fisher", "Brady Cook"]],
  ...
  "Lakers"=>["Jason Mericle", "Wed 7pm Court 7", ["Cooper Hladek", "Ryan Stratton", "Kaikoa Truong", "Jax Jensen", "Sebastian Flores", "Quentin Letcher", "Hunter Mericle"]],
  "Bucks"=>["Brennan Petar", "Wed 7pm Court 8", ["Matthew Bernardo", "Maxwell Porter", "Glenn Gordon", "Evan Ditto", "Spencer Pirtle", "Ozan David Kose-Montoya", "Finn Petar", "Braxton Landsman"]],
...
$girls_divisions = ["Girls K-2"=>[
  "Sparks"=>["Damien Pirro", "Mon 4pm Court 5", ["Isabella Webb", "Meyer Foust", "Tate Horvatic", "Gianna Kanik", "Emma King", "Emily Pirro", "Sophia Pirro"]],
  "Sun"=>["Mike Jensen", "Tue 5pm Court 5", ["Jade Blackmon", "Mila Coleman", "Charlotte Ferraro", "Savannah Geer", "Charlotte Hougland", "Avalon Jensen", "Reagan Mackey", "Kaylee Musser"]],
  "Storm"=>["James Decker", "Tue 5pm Court 5", ["Elise Kariuki", "Emma Berkley", "Matilda Brandon", "Mia Brooks", "Cece Decker", "Isla Fisher", "Violette Raubolt", "Bayyan Zeidan"]],
...
"Girls 3rd-5th"=>[
  ...
  "Spark"=>["Don Bunnin", "Mon 6pm Court 7", ["Olivia Bell", "Mia  Boussaa", "Lara Brandt", "Colette Bunnin", "Kaila Fukunaga", "Izzy Gallicchio", "Taylor Goodwin", "Emma Menchaca", "Aanya Nalajala", "Laila Bakhsh"]],
...
"Girls 6th-8th"=>[
  ...
  "Sun"=>["Ryan Weller", "Mon 7pm Court 8", ["Ava Boussaa", "Coco Conk", "Brooklyn Dillon", "Scotland Moss", "Perry Sudakoff", "Lily Weller", "Khaliya Scott"]],
  "Sparks"=>["Jen Waters", "Wed 7pm Court 5", ["Lyla Baldridge", "Georgia Ferrell", "Stella Grant", "Anabelle Kobus", "Olivia Matz", "Kaia Unell", "Presley Waters", "Olivia Silva"]],
