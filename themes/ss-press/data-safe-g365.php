...
if( strpos(site_url(), 'dev.') === false ) {
  wp_enqueue_script( 'js-g365-all', 'https://grassroots365.com/data-processor.js', array('jquery'), '695450', true );
} else {
  wp_enqueue_script( 'js-g365-all', 'https://dev.grassroots365.com/data-processor.js', array('jquery'), '695450', true );
}
...
?>
  <section id="content" class="grid-x grid-margin-x site-main large-padding-top xlarge-padding-bottom<?php if ( $ogp_ad_info['go'] ) echo $ogp_ad_info['ad_section_class']; ?>" role="main">
  	<div class="cell small-12">
<?php
		if ( $ogp_ad_info['go'] ) echo $ogp_ad_info['ad_before'] . $ogp_ad_info['ad_content'] . $ogp_ad_info['ad_after'];
